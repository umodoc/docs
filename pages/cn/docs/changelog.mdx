...
如果您仍然需要分页功能，可以继续使用 v4.x 版本，但是此版本将不再维护，当然，您也可以拉取代码自行修改，支持分页的代码分支为：https://github.com/umodoc/editor/tree/page-break-v4
</Callout>

## 🚀  v4.6.0 <Badge>2025-01-20</Badge>

1. 简化 placeholde 扩展，通过 css 实现；
2. 修复选中文字时鼠标移动到 block-handler上导致选中项乱闪的问题，由 @ChenErik 在 [(#72)](https://github.com/umodoc/editor/pull/72) 修复；
