...
1. 增加对 Markdown 图片输入和粘贴的支持；
2. 修复气泡菜单可能会显示不全的问题；
3. 修复退出格式刷后，气泡菜单不显示的问题；
4. 修复双击某个大纲标题会报错 @nishizbdjy [(#256)](https://github.com/umodoc/editor/issues/256)；
5. 修复当文件扩展没有被全量匹配时，会导致对齐失效的问题 @liushiji123 [(#254)](https://github.com/umodoc/editor/issues/254)；
6. 添加链接节点的气泡菜单；
7. 锁定版本依赖，防止因为 `prosemirror-mode` 版本不一致引起的错误 @BOKE2014 [(#257)](https://github.com/umodoc/editor/issues/257)。
