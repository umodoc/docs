...
7. 文档内容支持包含 `\n` 特殊字符的内容换行；
8. 修复文档中的链接打开无效的问题；
9. Word 文档导入时，文件大小可配置 [#276](https://github.com/umodoc/editor/issues/276) [#279](https://github.com/umodoc/editor/issues/279)；
...
18. 针对于 Nuxt3 用户，发布了 [Umo Editor Nuxt](https://www.npmjs.com/package/@umoteam/umo-editor-nuxt)。
