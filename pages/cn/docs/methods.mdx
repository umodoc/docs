...
### autoPagination <Badge theme="success">v5.0.0 新增</Badge>
...
**说明**：设置 Umo Editor 的显示语言。 <Badge theme="success">v2.1.0 新增</Badge>
...
**说明**：设置是否开启分页。 <Badge theme="success">v4.0.0 新增</Badge>
...
**说明**：获取当前选中节点信息。 <Badge theme="success">v3.0.0 新增</Badge>
...
**说明**：删除当前选中的节点。 <Badge theme="success">v3.0.0 新增</Badge>
