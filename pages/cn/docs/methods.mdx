...
**说明**：终止打字机插入内容效果。 <Badge theme="success">v6.0.0 新增</Badge>
...
**说明**：得到打字机的运行状态。 <Badge theme="success">v6.0.0 新增</Badge>
...
**说明**：插入Markdown格式文本。<Badge theme="success">v6.0.0 新增</Badge>
...
### getDocJSONByMarkdown

**说明**：把Markdown格式文本转成 Umo Editor 可识别的JSON结构数据。<Badge theme="success">v6.0.0 新增</Badge>

**参数**：`markData`，String，Markdown文本。

**参数**：`exRules`，object，Markdown扩展规则。

**返回值**：Umo Editor 可识别的JSON结构数据/null

### openAside

**说明**：打开右侧边栏展示区域。<Badge theme="success">v6.0.0 新增</Badge>

**参数**：`key`，String，右侧边栏唯一标识。

**返回值**：无

### closeAside

**说明**：关闭右侧边栏展示区域。<Badge theme="success">v6.0.0 新增</Badge>
...
**说明** ：打开 AI 聊天助手。 <Badge theme="success">v6.0.0 新增</Badge>
...
**说明** ：关闭 AI 聊天助手。<Badge theme="success">v6.0.0 新增</Badge>
