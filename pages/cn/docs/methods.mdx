...
**说明**：插入markdwon格式文本。<Badge theme="success">v6.0.0 新增</Badge>
...
**说明**：把markdown文本转成Umo Editor 可识别的JSON格式数据。<Badge theme="success">v6.0.0 新增</Badge>

**参数**：`markData`，String，markdown文本。

**参数**：`exRules`，object，markdown扩展规则。

**返回值**：Umo Editor 可识别的JSON格式数据或null
