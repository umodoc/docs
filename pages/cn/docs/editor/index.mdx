...
作为一个独立的 Vue3 插件，Umo Editor 可以轻松集成到各类 Vue3 项目中。对于非 Vue3 项目，您可以通过 Iframe 将 Umo Editor 嵌入到您的项目中，见[在非 Vue3 项目中使用](./editor/getting-started#在非-vue3-项目中使用)。
...
- **免费使用**：Umo Editor 基于[MIT 许可证](https://github.com/umodoc/editor/blob/main/LICENSE)对所有开发者免费开放，无需担心版权问题。
...
如果您不想保留版权信息，请联系我们或者购买商业版本 [Umo Editor Next](../next)。
