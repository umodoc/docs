...
<p style={{ textAlign: 'center' }}><a className="nextra-focus _text-primary-600 _underline hover:_no-underline _decoration-from-font [text-underline-position:from-font]" href="/en/docs/editor">[English Documentation]</a> | 中文文档</p>
...
如果您需要定制化开发，请联系我们，我们可以提供付费的定制化解决方案和商业支持。详细信息请访问[定制开发](./editor/customization)。
