...
**说明**：要禁用的菜单项，默认不禁用任何菜单项。该配置在 v8.0.0 及以后版本中已移除，请使用更友好的 [`disableExtensions` 配置项](./extensions#disableextensions)。<Badge theme="danger">v8.0.0 已移除</Badge>
