...
从 v2.1.0 版本开始，Umo Editor 支持暗色主题，您可以通过[https://umodoc.com/demo?theme=dark](https://umodoc.com/demo?theme=dark)，来体验暗色主题。
...
您可以访问[https://umodoc.com/demo?pane=themes](https://umodoc.com/demo?pane=themes)，在右侧设置面板中切换到“主题设置”选项卡，修改 CSS 变量 值，即可预览主题效果。
