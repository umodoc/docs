...
**参数**：`{ content, download, filename, docxOptions, exportComments, exportRevisions }`
...
- `docxOptions`：控制文档生成过程的配置信息，可选，包含以下配置项：
...
> - 当前 Word 导出的修订仅支持文本内容；若文档包含更复杂的节点级修订，建议先在编辑器内完成定稿后再导出。
