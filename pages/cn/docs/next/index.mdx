...
Umo Editor Next 是开源软件 Umo Editor 的增强版，在包含最新版本的 Umo Editor 所有功能的基础上，重点增强了对多用户在线协作编辑、文档批注(评论)、文档修订、文档标注、文档历史版本管理、AI 创作、文档导入导出、表格增强、Markdown 增强、内容锁定、文档模板管理、素材库等多种实用功能的支持，同时增强了工具栏和页边栏等区域的自定义能力。
