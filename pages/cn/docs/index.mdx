...
<img style={{marginTop: '1rem'}} src="/images/umo-editor-cn@2x.png" alt="umo editor" />

作为一个独立的 Vue3 插件，Umo Editor 可以零配置轻松集成到各类 Vue3 项目中，对于非 Vue3 项目，您可以通过 Iframe 将 Umo Editor 嵌入到您的项目中。

[Developer Documentation](https://editor.umodoc.com/en/docs) | [开发文档](https://editor.umodoc.com/cn/docs) | [在线演示](https://demo.umodoc.com/editor?lang=zh-CN) | [GitHub](https://github.com/umodoc/editor) | [码云(国内镜像)](https://gitee.com/umodoc/editor) | [NPM](https://www.npmjs.com/package/@umoteam/editor)
...
- [SerRashin](https://github.com/ChenErik)：🛠️ 为 Umo Editor 添加了俄语支持
...
如果您有任何疑问或建议，请通过以下方式联系我们，在此之前，建议您详细阅读本文档，以便您了解如何使用 Umo Editor。
...
- 💰 请我们喝杯咖啡。
<img src="/images/wepay.png" alt="请我们喝杯咖啡" style={{ margin: '0.5rem 0 0.5rem 1rem', width: '175px',border: '1px solid rgba(0, 0, 0, 0.05)',borderRadius: '4px' }} />

## 定制开发

如果您需要定制化开发，请联系我们，我们可以提供付费的定制化解决方案和商业支持。详细信息请访问[定制开发](./docs/customization)。

## 开源协议

Umo Editor 采用[MIT 许可证](https://github.com/umodoc/editor/blob/main/LICENSE)，您可以免费使用、修改和使用本软件。
