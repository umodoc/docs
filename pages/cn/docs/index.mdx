...
<p style={{ textAlign: 'center' }}><a class="nextra-focus _text-primary-600 _underline hover:_no-underline _decoration-from-font [text-underline-position:from-font]" href="/en/docs">[English Documentation]</a> | 中文文档</p>
