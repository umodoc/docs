...
Umo Editor 主要的主题变量使用 [CSS Variables](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Using_CSS_custom_properties) 声明，我们推荐使用替换 CSS Variables 的方式来进行个性化的主题配置。

## CSS Variables

以下是所有可用的 CSS Variables，[点击此处](https://github.com/umodoc/editor/tree/main/src/assets/styles/_variables.less) 可查看完整的 CSS Variables 列表。
...
您可以访问 https://demo.umodoc.com/editor?tab=themes ，在右侧设置面板中切换到“主题设置”选项卡，修改 CSS Variables 值，即可预览主题效果。
