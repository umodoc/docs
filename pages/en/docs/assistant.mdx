...
The AI Assistant is an efficiency tool integrated with artificial intelligence technology, primarily designed to enhance the efficiency of document creation.

The AI Assistant passes the content selected by the user and the input instructions to the AI model. The AI model, based on this information, generates document content that meets the requirements and returns the results to the AI Assistant.

## Technical Principles

### Process Description
1. The user sends a command to the AI Assistant, specifying the action they wish to perform;
2. The AI Assistant then invokes a method named `onAssistant`;
...
5. The `onAssistant` method returns the result in a readable stream or text format to the AI Assistant;
6. The user selects the results returned by the AI Assistant.
...
sequenceDiagram
    ...
    participant AIDocAssistant as AI Assistant
...
The AI Assistant can be applied in various scenarios, providing efficient and intelligent document processing services. Here are some common use cases:
...
By utilizing the AI Assistant, work efficiency can be significantly increased, repetitive labor can be reduced, and users can focus on more creative and strategic tasks.