...
### versions.includeComments

**Description**: When creating a version, whether to include comments/threads in the snapshot. <Badge theme="success">Added in v11.0</Badge>
