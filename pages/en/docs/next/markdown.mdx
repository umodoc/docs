...
* `document.markedOptions.instance`: A Marked instance. You may pass in an externally created instance to enable more flexible and advanced customization.
...
**Description**: Returns the internal `MarkdownManager` instance used by the editor.
