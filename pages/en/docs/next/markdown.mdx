...
- Use Markdown import/export as an exchange format when integrating with the broader Markdown ecosystem: [Import](./import), [Export](./export)

### Collaboration and Comments

- Great for teams maintaining a Markdown-style handbook with real-time collaboration and threaded discussions: [Collaborative Editing](./collaboration), [Comments](./comments)

### AI

- Markdown-structured AI output is more stable and can be inserted directly for further editing: [AI](./ai)
