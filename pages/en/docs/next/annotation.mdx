...
- Annotations sync in collaboration mode, which is great for remote meetings and reviews: [Collaborative Editing](./collaboration)
- Enabling annotation triggers edit protection to reduce conflicts

### Comments

- Use annotation for “visual pointing”; use comments for “explanation and decisions”: [Comments](./comments)

### Track Changes

- Use annotation to point out where the problem is, and Track Changes to implement and finalize the actual edit: [Track Changes](./revision)

## Screenshot

![Umo Editor document annotaion](https://s2.umodoc.com/demos/annotation-en.png)
