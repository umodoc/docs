...
<Callout type="warning" emoji="⚠️"> This configuration was removed in v10.0. Please refer to <a href="./markdown">Markdown Enhancements</a> for the new Markdown support mechanism. </Callout>
