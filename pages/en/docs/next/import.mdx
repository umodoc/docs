...
- For standardized documents such as application forms, contracts, medical records, and registration sheets, you can further turn imported content into variable-driven templates: [Document Forms](./form)
