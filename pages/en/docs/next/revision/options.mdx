...
- Node changes (some node types): inserting/removing trackable nodes writes attributes like `data-track-change-type`, `data-track-id`, `data-op-user-*`, and `data-op-date` and shows them as change records in the review panel.
