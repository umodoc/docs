...
1. [Use Cases](./scenarios): first confirm whether it fits your business
2. [Getting Started](./getting-started): get the minimum flow working first
3. [Core Concepts](./concepts): understand modes, boundaries, and how to choose the right approach
4. [Configuration](./options) and [Methods](./methods): complete the formal integration
5. [Field Design](./field-design): design your template fields properly
6. [Troubleshooting](./troubleshooting): handle programmatic population and fallback scenarios
