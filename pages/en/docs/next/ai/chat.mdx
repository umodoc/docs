...
The AI Chat Assistant is an intelligent interaction tool designed for document editing. It allows users to converse with AI in real time while editing, providing smart suggestions such as continuation, rewriting, polishing, and translation based on selected text or surrounding context. Supporting multi-turn conversations, history management, and file uploads, it helps users efficiently create and optimize documents.

## Effect Screenshot

![AI Chat Assistant](https://s2.umodoc.com/demos/ai-chat-en.png)
...
AI Chat Assistant configuration. For more details, see [AI Document Assistant](../editor/ai).
...
- `ai.chat.commands`: Array – commonly used commands. See [AI Document Assistant Configuration](../editor/options/ai#aiassistantcommands).
