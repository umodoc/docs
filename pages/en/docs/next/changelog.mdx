...
1. Added the new **Business Objects** feature. See: [Business Objects](./biz-block);
2. Optimized insertion and export behavior for SVG diagram nodes such as flowchart, Mermaid, and PlantUML;
3. Improved clarity when exporting image nodes to Word documents;
4. Fixed an issue where child lists did not update their numbering type after switching list numbering in the menu;
5. Improved insertion behavior for Mermaid and other SVG image nodes;
6. Fixed an issue where excessive toolbar scrolling could prevent some menu items from ever becoming visible;
7. Other minor refinements.
