...
7. Added the `floating_action` slot, see [Configuration & Methods - Slots](./ai/options#slots);
8. Fixed an issue where the menu bar still showed a save prompt in collaboration mode.
9. Fixed an issue where tables could expand infinitely in width in certain edge cases.
10. Enhanced comment functionality;
11. Improved import and export capabilities;
12. Many detail fixes and optimizations.
