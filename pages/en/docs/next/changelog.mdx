...
3. Added real-time saving of page info (such as page size and background) in collaboration mode, and synced it to other collaborators in real time.
4. Fixed an issue where the menu bar still showed a save prompt in collaboration mode.
5. Fixed an issue where tables could expand infinitely in width in certain edge cases.
6. Optimized comments features;
7. Optimized import and export features;
8. Many detail fixes and optimizations.
