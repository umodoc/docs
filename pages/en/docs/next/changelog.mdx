...
5. Fixed an issue where the menu bar still showed a save prompt in collaboration mode.
6. Fixed an issue where tables could expand infinitely in width in certain edge cases.
7. Enhanced comment functionality;
8. Improved import and export capabilities;
9. Many detail fixes and optimizations.
