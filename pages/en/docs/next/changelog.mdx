...
2. Fixed incorrect block menu icon display;
3. Completed file-related copy and corrected over-limit prompts;
4. Improved FlowChart rendering error messages.
...
<Callout type="warning" emoji="❗">
  To maintain code synchronization with Umo Editor, Umo Editor Next adopts the
  same major version number as Umo Editor, starting directly from v7.0.0.
</Callout>
