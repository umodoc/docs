...
3. Added the ability to import web pages, allowing users to directly import content from any webpage 😂😂😂;
4. Added real-time saving of page info (such as page size and background) in collaboration mode, and synced it to other collaborators in real time.
5. Added the `floating_action` slot, see [Configuration & Methods - Slots](./ai/options#slots);
6. Fixed an issue where the menu bar still showed a save prompt in collaboration mode.
7. Fixed an issue where tables could expand infinitely in width in certain edge cases.
8. Enhanced comment functionality;
9. Improved import and export capabilities;
10. Many detail fixes and optimizations.
