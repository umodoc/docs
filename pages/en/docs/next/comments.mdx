...
When collaborative editing is enabled, you can also obtain the `provider` via [`getCollaborationInfo`](./collaboration#getcollaborationinfo), and use it to manage comments—this requires deeper understanding of [Hocuspocus](https://tiptap.dev/docs/hocuspocus).
