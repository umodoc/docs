...
- Lock the template skeleton and let business users fill only variable fields: [Template Management](./template)

### Document Forms

- In form templates, lock the fixed skeleton and expose only the variable areas to fillers to reduce accidental edits: [Document Forms](./form)

### Track Changes

- Enable Track Changes during template maintenance or content edits, finalize, then lock critical clauses: [Track Changes](./revision)

### Collaboration and Comments

- In collaboration mode, lock confirmed sections and use comments to converge decisions on the remaining parts: [Collaborative Editing](./collaboration), [Comments](./comments)
