...
If you still need pagination, you can continue using the v4.x versions, but these versions will no longer be maintained. Alternatively, you can fork the code and modify it yourself. The branch supporting pagination is available at: https://github.com/umodoc/editor/tree/page-break-v4
</Callout>

## 🚀  v4.6.0 <Badge>2025-01-20</Badge>
