...
## Dark Mode
Starting from version v2.1.0, Umo Editor supports a dark theme, which you can experience through the following link: https://demo.umodoc.com/editor?theme=dark&lang=en.
