...
Before v9.0, only text nodes could have custom content added. Starting from v9.0, custom content can be added to all nodes, and slot parameters such as `nodeType` and `nodeAttrs` are supported for more flexible menu customization.
</Callout>
