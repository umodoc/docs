...
Starting from v3.0, Umo Editor has opened up some UI-related components. See [Components](./components). In addition to the open components, to maintain UI consistency, you can use the [CSS variables](./themes#css-variables) provided by Umo Editor in your UI.
