...
- `locale`: String, display language, default is `zh-CN`. <Badge theme="success">Added in v2.0.0</Badge>
- `theme`: String, theme setting, default is light theme. <Badge theme="success">Added in v2.1.0</Badge>
- `skin`：String, Appearance setting. <Badge theme="success">Added in v10.0.0</Badge>
...
- `disableExtensions`: Array, see [Custom Extensions](./extensions). <Badge theme="success">Added in v8.0.0</Badge>
