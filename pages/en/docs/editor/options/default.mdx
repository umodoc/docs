...
The default configuration of Umo Editor. You can visit https://www.umodoc.com/en/demo to modify and preview some configurations online in real-time.
...
const defaultOptions = {
  ...
  toolbar: {
    showSaveLabel: true, // Added in v9.0.0
    defaultMode: 'ribbon',
  ...
  document: {
    ...
    placeholder: {
     ...
     structure: 'block*', // Added in v10
    enableSpellcheck: true,
    enableMarkdown: true,
    enableBubbleMenu: true,
    enableBlockMenu: true,
    enableNodeId: false, // Added in v10
    readOnly: false,
    autofocus: true,
    characterLimit: 0,
    typographyRules: {},
...
- `skin`：String, appearance-related setting. <Badge theme="success">Added in v10.0.0</Badge>
...
- `importWord`: Object, Word document import configuration, see [Word Import Configuration](./import-word). <Badge theme="success">Added in v8.0.0</Badge>
- `extensions`: Array, see [Features and Extensions](./extensions). <Badge theme="success">Added in v1.4.0</Badge>
- `disableExtensions`: Array, see [Features and Extensions](./extensions). <Badge theme="success">Added in v8.0.0</Badge>
- `translations`: Object, see [Localization Language](./locales). <Badge theme="success">Added in v2.0.0</Badge>
