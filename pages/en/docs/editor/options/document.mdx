...
**Description**: Configures the document structure. With this option, you can enforce a specific document structure—for example, to require the first node to be a document heading, you can set this option to `heading block*`.
For a Tiptap example, see: [https://tiptap.dev/docs/examples/advanced/forced-content-structure](https://tiptap.dev/docs/examples/advanced/forced-content-structure) <Badge theme="success">Added in v10.0.0</Badge>
...
**Description**: Determines whether unique identifiers should be generated for document nodes. This option is disabled by default to achieve better performance. <Badge theme="success">Added in v10.0.0</Badge>
...
**Default Value**: `false`, Default was true before v10
