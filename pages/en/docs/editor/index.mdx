...
<p style={{ textAlign: 'center' }}>English Documentation | <a className="nextra-focus _text-primary-600 _underline hover:_no-underline _decoration-from-font [text-underline-position:from-font]" href="/cn/docs/editor">[中文文档]</a> </p>
