...
Umo Editor is a document editor based on Vue3 and Tiptap3.
...
<Callout type="warning" emoji="⚠️">
  **Note**: Starting from version v3.0, Umo Editor no longer supports the UMD
  version.
</Callout>
...
<Tabs items={["Method 1: Using @umoteam/umo-editor-nuxt Module", "Method 2: Direct Import"]}>
<Tabs.Tab>
...
<Tabs.Tab>
Umo Editor does not currently support SSR. In Nuxt SSR mode, you can use the `<client-only>` component or other methods to ensure Umo Editor is rendered and used on the client side.
