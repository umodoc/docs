...
Umo Editor Next's changelog can be found at: https://dev.umodoc.com/cn/docs/next/changelog
...
Starting from v6.0.0, Umo Editor has launched Umo Editor Next, providing a more advanced editing experience. For more updates, please visit: https://dev.umodoc.com/cn/docs/next .
</Callout>
