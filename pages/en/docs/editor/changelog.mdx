...
5. Fixed an issue where line height could be lost when inserting a heading block into an empty line, contributed by @ohmua in [(#397)](https://github.com/umodoc/editor/pull/455);
