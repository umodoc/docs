...
<Callout type="info" emoji="❗">
  This release is a **major milestone upgrade**. Without breaking existing
  configurations or usage patterns, the core of Umo Editor has been seamlessly
  migrated to **Tiptap v3**, along with a systematic refactoring of the overall
  codebase. This upgrade significantly **reduces bundle size**, **improves
  loading and editing performance for large documents**, and lays a much more
  solid foundation for future feature expansion and long-term maintenance. **We
  strongly recommend all users upgrade to this version.**
</Callout>
