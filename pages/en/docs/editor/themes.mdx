...
Starting from version v2.1.0, Umo Editor supports a dark theme. You can experience the dark theme by visiting [https://www.umodoc.com/en/demo?theme=dark](https://www.umodoc.com/en/demo?theme=dark).
...
You can visit [https://www.umodoc.com/en/demo?pane=themes](https://www.umodoc.com/en/demo?pane=themes), switch to the "Theme Settings" tab in the right-side settings panel, and modify the CSS variable values to preview the theme effects.
