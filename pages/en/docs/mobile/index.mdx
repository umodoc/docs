...
- **Supports collaboration**: Online collaborative editing is now available, and the mobile editor can share the same collaborative document with the desktop side.
...
- If you need multi-user real-time editing, continue with [Online Collaboration](./mobile/options/collaboration).
