...
- If you want to understand capability boundaries, read [Features](./mobile/features.md) and [Roadmap](./mobile/roadmap.md).  
- If you are integrating with business logic, focus on [Configuration](./mobile/options/default.md), [Events](./mobile/events.md), and [Methods](./mobile/methods.md).
- If you need secondary development, continue with [Slots](./mobile/slots.md) and [Extensions](./mobile/extensions.md).
...
See [LICENSE](LICENSE) or visit: https://dev.umodoc.com/en/docs/license
