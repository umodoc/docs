...
In the Umo Editor Next version, we provide a more powerful AI Chat Document Assistant feature. See [Umo Editor Next Configuration Options](../next/options) for details.
