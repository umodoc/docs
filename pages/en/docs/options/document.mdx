...
**Description**: Whether to enable the block menu. You can dynamically set whether to display the block menu using the [`setDocument`](../methods#setdocument). <Badge theme="success">Added in v1.3.0</Badge>
