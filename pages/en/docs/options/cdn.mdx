...
**Note**: After updating the version of `@umoteam/editor`, and copy the latest `@umoteam/editor-external` to the `public` directory. Ensure synchronization with the version number of `@umoteam/editor-external`.
</Callout>
