...
The default configuration for Umo Editor allows you to modify and preview some settings online at [https://demo.umodoc.com/editor](https://demo.umodoc.com/editor?lang=en).
...
- `extensions`: Array [Custom Extensions](./extensions). <Badge theme="success">Added in v1.4.0</Badge>
- `translations`: Object [Custom Localization Configuration](./locales). <Badge theme="success">Added in v2.0.0</Badge>
- `onSave(content, page, document)`: Async Function, document save method, should return a Promise, see [Methods](/en/options/methods#onSave).
- `onFileUpload(file)`: Async Function, file upload method, should return a Promise, see [Methods](/en/docs/options/methods#onFileUpload).
