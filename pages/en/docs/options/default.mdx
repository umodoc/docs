...
- `extensions`: Array [Custom Extensions](./extensions). <Badge theme="success">New in v1.4.0</Badge>
- `translations`: Object [Custom Localization Configuration](./locales). <Badge theme="success">New in v2.0.0</Badge>
