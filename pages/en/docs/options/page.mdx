...
**Description**: Default page layout, can be set to page mode or web mode. You can dynamically modify the default layout using the [`setPage`](../methods#setpage) method. <Badge theme="success">Added in v8.0.0</Badge>
