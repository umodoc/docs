...
Mainly used to configure the settings of third-party pages when inserting them. You can modify and extend the configuration for inserting third-party pages by adjusting these settings.
