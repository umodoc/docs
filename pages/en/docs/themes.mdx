...
Umo Editor's primary theme variables are declared using [CSS Variables](https://developer.mozilla.org/en-US/docs/Web/CSS/Using_CSS_custom_properties). We recommend customizing themes by replacing CSS variables.

## Dark Theme

Starting from version v2.1.0, Umo Editor supports a dark theme. You can experience the dark theme by visiting [https://demo.umodoc.com/editor?theme=dark&lang=en-US](https://demo.umodoc.com/editor?theme=dark&lang=en-US).

### Theme Configuration
See [Theme Configuration](./options/themes).

### Theme Methods
See [Theme Configuration](./methods#settheme).

### Theme Events
See [Theme Configuration](./events).

## CSS Variables

Below are all available CSS variables. [Click here](https://github.com/umodoc/editor/tree/main/src/assets/styles/_variables.less) to view the full list of CSS variables.
...
You can visit [https://demo.umodoc.com/editor?pane=themes&lang=en-US](https://demo.umodoc.com/editor?pane=themes&lang=en-US), switch to the "Theme Settings" tab in the right-side settings panel, and modify the CSS variable values to preview the theme effects.
