...
**Parameters**: Valid HTML format or other valid [Tiptap document formats](https://tiptap.dev/docs/editor/guide/output).

**Return Value**: None.

### setLocale 

**Description**: Sets the display language of Umo Editor. <Badge theme="success">Added in v2.0.0</Badge>
...
**Description**: Returns the display language of Umo Editor. <Badge theme="success">Added in v2.0.0</Badge>
...
**Description**: Returns the [`vue-i18n`](https://vue-i18n.intlify.dev/guide/introduction.html) instance. <Badge theme="success">Added in v2.0.0</Badge>
...
**Description**: Prints the page. <Badge theme="success">Added in v1.1.0</Badge>
