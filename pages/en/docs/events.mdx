...
This section introduces the events of Umo Editor. Events allow you to monitor the complete lifecycle and state changes of Umo Editor for further operations. You can visit [https://umodoc.com/en/demo?pane=events](https://umodoc.com/en/demo?pane=events) and open the console (DevTools › Console) to observe event triggers.
