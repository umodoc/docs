...
Umo Editor Server is a companion server-side software developed to enhance some features of Umo Editor Next, such as multi-user online collaborative editing, document comments, document import/export, etc. If you have already purchased the [commercial license](../next/buy) for Umo Editor Next, you can use Umo Editor Server for free under the [Umo Team Commercial Software License Agreement](../next/license).
...
Umo Editor Server is not distributed as an NPM package. After obtaining a [commercial license](../next/buy), you can directly pull the source code from the private repository and modify and deploy it as needed.
